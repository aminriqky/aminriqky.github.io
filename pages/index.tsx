          ...
          <div className="flex flex-row mt-40 justify-center ml-[25%] mr-[25%]">
            ...
            <div className="flex flex-col">
              ...
              <p className="paragraph">
                Hello, my full name is Muhammad Amin Riqky, and people who knew
                me call me Amin. Now, I live in Palembang, South Sumatera. I was
                born in Palembang, on 13 November 2000. I strive to be the one
                of best Web and App Developer at every project so i'm always
                learning.
              </p>
            </div>
          </div>
          <div className="border-y-8 border-slate-500 bottom-0 absolute">
            <div
