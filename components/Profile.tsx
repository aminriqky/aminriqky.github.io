...
const Profile = () => {
  ...
  useEffect(() => {
    if (profil === "") {
      setProfil("Hello, my full name is Muhammad Amin Riqky, and people who knew me call me Amin. Now, I live in Palembang, South Sumatera. I was born in Palembang, on 13 November 2000. I strive to be one of the best Web and App Developer at every project so i'm always learning.")
    }
  });
    ...
    <Fragment>
      <div id="profile" className="flex justify-center">
        ...
        <div className="absolute bg-[#3b374a] w-full h-96 z-0 mt-40">
          <div className="flex flex-row mt-40 ml-[25%] mr-[25%]">
