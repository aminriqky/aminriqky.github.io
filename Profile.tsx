  ...
  return (
    <div id="profile" className="flex justify-center">
      ...
      <div className="flex-row mx-8 z-10">
        <p className="font-bebas-neue 2xl:tracking-[.130em] text-2xl xl:text-5xl mt-24">
          Muhammad Amin Riqky | Tech Enthusiast
        </p>
        <div
          className="rounded-md shadow-sm mt-3"
          role="group"
        >
          <button
          ...
          <button type="button" className="btn-primary rounded-r-lg">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="w-4 h-4 fill-current"
              viewBox="0 0 19 19"
